...
namespace MyFreeFormForm.Data.Migrations
{
    ...
    [Migration("20240427171134_update_notesField_name")]
    partial class update_notesField_name
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFreeFormForm.Models.FormField", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FieldDateTimeOffsetValue")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTime?>("FieldDateValue")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MyFreeFormForm.Models.FormSubmissionQueue", b =>
                {
                    ...
                    b.Property<string>("FormModelData")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyFreeFormForm.Data.MyIdentityUsers", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyFreeFormForm.Models.FormField", b =>
                {
                    b.HasOne("MyFreeFormForm.Models.Form", null)
                        .WithMany("FormFields")
